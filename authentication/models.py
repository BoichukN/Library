...
class CustomUser(AbstractBaseUser):
    ...
    def create(email, password, first_name=None, middle_name=None, last_name=None):
        ...
        """
        data = {'first_name': first_name if first_name else '', 'last_name': last_name if last_name else '',
                'middle_name': middle_name if middle_name else '', 'email': email}
